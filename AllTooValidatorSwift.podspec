...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Jordan Rojas Alarcón/AllTooValidatorSwift'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Jordan Rojas Alarcón' => 'rojas.curl@gmail.com' }
  s.source           = { :git => 'https://github.com/Jordan Rojas Alarcón/AllTooValidatorSwift.git', :tag => s.version.to_s }
